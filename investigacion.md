...
| **🆕 The Springs Resort** (no estaba documentado) | ~US$120 por persona en temporada alta (fin nov-inicios abr), algo menos en baja (abr-oct) | Resort 5 estrellas, ~30 piletas termales distintas. El pase de día **incluye además** cabalgata, kayak de río, escalada y tirolesa, más un santuario de animales rescatados en el medio del predio (perezosos, tucanes, monos, jaguares) para verlos de cerca. Venden pases limitados por día, así que no se siente lleno. Spa, varios restaurantes/bares, tobogán. Emma no se hospedó ahí, pero la recomienda para un día especial (luna de miel, cumpleaños). La ubica 2ª en su ranking — dice que con este pase "hacés un día entero" solo, porque reemplaza varias actividades pagas sueltas. |
...
**El punto que hizo Daniel en el audio, sin resolver todavía:** cuánto tiempo del día consume cada opción y cuánta flexibilidad saca. En la gratis, si no gusta, te vas en 15 minutos sin culpa. Pagando US$65-120, la lógica cambia — da la sensación de "tengo que aprovechar el día entero para que valga la pena", lo que puede trabar el resto del itinerario de esa fecha. The Springs, en cambio, es un caso distinto: si el pase ya incluye zipline/kayak/cabalgata/santuario de animales, ocupar el día entero ahí podría no ser "perder flexibilidad" sino consolidar varias actividades pagas que hoy están sueltas en el itinerario (Arenal 1968, Bogarín, etc.) en un solo lugar — a evaluar si conviene comparar el combo contra la suma de esas actividades por separado.
