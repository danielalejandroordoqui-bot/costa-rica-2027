...
- **Día 8 (sáb 27/3):** Uvita — Ballenas + regreso a SJO (⚠️ sujeto a marea)
  - **Parque Nacional Marino Ballena** — de mañana. Tres formas, sin decidir todavía:
    - **(A) Tour en lancha guiado** — ~US$85-105/persona, ~3h, sale ~8:15am con café/fruta/snacks antes de zarpar, guía explica biología y migración, termina dejando en la Cola de Ballena. Operadores relevados: Ballena Tour Costa Rica (US$85, [ballenatourcostarica.com](https://ballenatourcostarica.com/)), varios listados en GetYourGuide (US$92-105/3h), otro operador US$90 adulto/US$70 niño. Ninguno garantiza avistamiento.
    - **(B) Entrada independiente SINAC** — US$12/adulto, caminar el tómbolo por cuenta propia sin barco.
    - **(C) Isla del Caño — snorkel, en vez de las ballenas** — ~US$100-150/persona, tour 7am-3pm, de lo mejor del país para ver tortugas/rayas/meros. Termina a las 3pm en Uvita, con margen de sobra para salir a SJO igual (3h18min de manejo, devolución del auto recién a las 21:00). **Corregido 20/9/2026:** se había descartado por error tratándolo como "necesita día propio" — no es así, es una alternativa real al plan de ballenas para este mismo día.
  - ⚠️ **Expectativa honesta para el 27/3 (research 20/9/2026):** la temporada del hemisferio norte es **dic-mediados de marzo**, pico en ene-feb — mytanfeet (fuente ya usada en este proyecto) dice textual que "la actividad generalmente empieza a bajar después de mediados de marzo". El 27/3 ya cae pasado ese punto: realista esperar avistamientos parciales (soplidos, aletas, alguna cola a la distancia), no necesariamente un espectáculo cercano. Esto coincide con lo que Daniel vio en varios videos ("pedacitos pequeños, no es wow") — y es el argumento a favor de considerar la opción (C) en vez de las ballenas.
  - **Cola de Ballena (tómbolo)** — el sendero de arena con forma de cola solo se camina en una ventana de ~6h alrededor de la marea baja (aplica solo a las opciones A/B). Hay que revisar la tabla de mareas cerca de la fecha para armar el horario de la mañana.
  - Salida hacia SJO a media tarde, 3h18min/210km — más corto que el viejo tramo Manuel Antonio→SJO. Con la opción (C) el tour ya vuelve a las 3pm, con margen de sobra.
...
⚠️ **Depurado 20/9/2026 — sacado del `index.html` en vivo, este research queda solo acá como historial:** con el itinerario en pulido activo, se decidió que todo lo que necesita una noche/día propio no tiene lugar lógico en los 9 días ya completos (7 noches repartidas entre 4 zonas, sin ningún hueco libre) — se descarta directamente en vez de dejarlo "por si acaso". Lo que sigue compitiendo por un hueco que YA existe en el esqueleto (Día 3, Día 8) se mantiene documentado abajo y en el sitio.
...
- **Playa Ventanas (nuevo, 20/9/2026):** cuevas marinas talladas por el mar, se exploran en marea baja — ~15-20 min al sur de Uvita, sobre la misma zona del Día 8. Parada corta, no confirmado si entra ese día (ya tiene tour de ballenas + manejo a SJO) o si queda como "si sobra tiempo". *(WebSearch 20/9/2026)*
- ✅ **Isla del Caño — snorkel — RECLASIFICADO 20/9/2026 (corrección de un error propio):** se había puesto en el tier "Medio, descartado" tratándolo como "necesita día propio, mismo problema que Isla Venado" — Daniel marcó con razón que había que revisar el detalle antes de tirarlo. Al chequear los horarios: el tour sale ~7am y **vuelve ~3pm**, dejando margen de sobra para el viaje a SJO (3h18min) antes de la devolución del auto a las 21:00. **No necesita día propio — es una alternativa real al tour de ballenas para el Día 8 mismo**, no algo que rompa el itinerario. Reserva biológica a ~1h20 en lancha desde Uvita, considerada de lo mejor del país para snorkel (tortugas, rayas, meros). US$100-150/persona (incluye equipo, guía, almuerzo, tasas del parque). Cupo diario limitado por el gobierno, reservar con al menos 1 semana de anticipación en temporada alta (dic-abril). *(WebSearch 20/9/2026)*
