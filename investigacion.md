...
Daniel pasó 2 videos de Emma Terra (canal ya usado antes en el proyecto) dedicados enteramente a comparar termas de La Fortuna, y pidió revisarlos a fondo porque "sirven para una decisión final". Se transcribieron completos (subtítulos). Ella visitó La Fortuna ~8 veces en 15 años y hace un ranking propio. **Nada de esto está decidido — es información nueva para sumar a la comparación, Eco Termales sigue siendo lo que está en el plan.**

| Opción | Precio | Qué incluye |
|---|---|---|
| **Termas gratis (junto a Tabacón)** | Gratis + ~US$10 de parqueo (₡5.000, a locales en la ruta) | Río natural que corre por la selva, calentado por el volcán. Sin baños ni vestuarios: llevar toalla propia y bolsa impermeable. Recomienda sandalias con correa (no ojotas, las rocas son resbalosas). Se puede estar 15 min o 3 horas, total libertad — es lo más flexible de las 4. Va mucha gente pero el río es grande, se consiguen pozas propias. Mejor cerca del atardecer, se vacía. |
| **Eco Termales (lo que está en el plan)** | Emma dice ~US$65 el pase (día o noche) — más alto que nuestro dato de ~US$48,60-75,71; a reconfirmar más cerca de la fecha | Pileta icónica de arena negra en cascada, otras piletas con sillones integrados, bar, restaurante, vestuarios, toallas incluidas. Es también hotel. Emma la ubica 3ª en su ranking, "muy buena relación precio-calidad". |
...
⚠️ **Nuestro Día 2 es domingo 21/3**, y además el viaje entero tiene Semana Santa superpuesta (ver nota general del proyecto). Las tres opciones se ven afectadas, de formas distintas:
...
- **La gratuita tiene nombre: se llama "El Choyin"** — así aparece en Google Maps y en las guías, coordenadas de parqueo ~10.4887689, -84.7244539, a ~13 km de La Fortuna (~18 min en auto). Del parqueo son 50 m caminando por un sendero de ripio hasta el río; se puede seguir 90 m río arriba a pozas más tranquilas. **Sin cargo oficial de parqueo**, pero en horas pico hay gente con chaleco reflectivo pidiendo ₡1.000-5.000 (~US$1,80-9) — no son autoridad, es igual al patrón de cuidacoches ya documentado en el proyecto. Llevar candado/no dejar nada de valor en el auto: hay robos reportados. Calzado de agua recomendado, piedras filosas río arriba.
  - ⚠️ **Hallazgo clave para nuestra fecha:** una guía dedicada a este lugar dice textual "avoid weekends entirely" (evitar los fines de semana por completo) por la multitud — y nuestro Día 2 es domingo. En Semana Santa además se suma que los locales también están de vacaciones, así que se espera más gente todavía, no menos. Ir antes de las 8am es lo que recomiendan para tener el río más tranquilo (y de paso, avistar coatíes y aves). La temporada seca (marzo) no alivia la multitud entre semana, mucho menos en fin de semana largo.
...
- **Día 2 (dom 21/3):** La Fortuna — Termas y catarata
  ...
  - 📍 Volcán Arenal · Eco Termales · Catarata La Fortuna · Red Frog Coffee Roasters
  - 🧭 **Extras de Two Roaming Souls (opcionales, no reemplazan nada; datos de 2025, reconfirmar):**
    ...
    - **El Salto (soga y pozón)** — gratis. Puente peatonal sobre el río y bajada corta a un pozón para nadar, saltar de las rocas o colgarse de la soga; para TRS fue la mejor actividad gratuita de todo su viaje. El parqueo sobre la ruta es gratis, aunque un local les pidió plata al irse. Corrientes que cambian rápido y remolinos: bajo propia responsabilidad.
    - **Termas más baratas que Eco Termales (para comparar, no para reemplazar)** — las termas gratis pegadas a Tabacón (parqueo de US$10 de dudosa oficialidad, sendero corto, sin baños ni vestuarios, río tibio "como una bañera") o Thermales Los Laureles, US$15 por persona, con toboganes, piletas y snack bar.
...
- **Día 3 (lun 22/3):** La Fortuna — Blue Falls (mañana libre)
  ...
  - 🧭 **Río Celeste como alternativa a Blue Falls (comparación, decisión pendiente de Daniel):**
    ...
    - **Frente a Blue Falls (Bajos del Toro):** Río Celeste tiene un color más famoso y un sendero más largo, pero no se nada en el parque, hay más gente y el paseo entero ronda las 5h40-6h20. Blue Falls es un paseo de ~4h con piletas para nadar y sin reserva. Cualquiera de los dos ocupa casi todo el día y no entran los dos (con el kayak ya descartado, la mañana del Día 3 está libre). La opinión de TRS sobre Río Celeste: "mucho viaje para una sola atracción", aunque si te obsesiona ese color vale la pena.
